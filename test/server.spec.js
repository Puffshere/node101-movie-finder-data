...
mock
  .onGet('http://www.omdbapi.com', { params: { i: 'tt3896198', apiKey: 'bebfe443' }})
  .replyOnce(withMovie(0))
	.onGet('http://www.omdbapi.com/', { params: { i: 'tt3896198', apiKey: 'bebfe443' }})
  .replyOnce(withMovie(0))
  .onGet('http://www.omdbapi.com/?i=tt3896198&apikey=bebfe443')
  .replyOnce(withMovie(0))
  .onGet('http://www.omdbapi.com/?apikey=bebfe443&i=tt3896198')
  .replyOnce(withMovie(0))
  .onGet('http://www.omdbapi.com', { params: { t: 'baby driver', apiKey: 'bebfe443' }})
  .replyOnce(withMovie(1))
  .onGet('http://www.omdbapi.com/', { params: { t: 'baby driver', apiKey: 'bebfe443' }})
  .replyOnce(withMovie(1))
  .onGet('http://www.omdbapi.com/?t=baby%20driver&apikey=bebfe443')
  .replyOnce(withMovie(1))
  .onGet('http://www.omdbapi.com/?apikey=bebfe443&t=baby%20driver')
  .replyOnce(withMovie(1))
